...
static char *startpage      = "https://start.duckduckgo.com";
...
static Key keys[] = {
	...
	{ GDK_CONTROL_MASK,      GDK_KEY_f,      scrollv,    { .i = +50 } },
	{ GDK_CONTROL_MASK,      GDK_KEY_b,      scrollv,    { .i = -50 } },
...
static SearchEngine searchengines[] = {
        { "s",   "http://www.duckduckgo.com/?q=%s"},
        { "g",   "http://www.google.com/search?q=%s"},
        { "dict","http://www.dict.cc/?s=%s"},
        { "wiki","http://www.wikipedia.org/wiki/%s"},
        { "yt",  "http://www.youtube.com/search?q=%s"},
};
